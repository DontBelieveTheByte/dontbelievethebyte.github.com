...
* Can switch between big player and list view mode.

![Screenshot media player](/assets/img/skipshuffle/list_view.png)

* Works across most phones and tablet from Android 4.0 (Ice Cream Sandwich) and up.

![Screenshot media player](/assets/img/skipshuffle/tablet.png)

![Screenshot media player](/assets/img/skipshuffle/phone.png)

* Customize the look and feel with over 16 different themes.

![Screenshot media player](/assets/img/skipshuffle/themes.png)

* Control from the notification area

![Screenshot media player](/assets/img/skipshuffle/notification.png)

* Control widget for all Android versions and 

![Screenshot media player](/assets/img/skipshuffle/control_widget.png)

* lock screen widget for Android 4.4 and up.

![Screenshot media player](/assets/img/skipshuffle/lock_screen_widget.png)
...
<STYLE>#qp_main215396 .qp_btna:hover input {background:rgb(150,150,150)!important}</STYLE><div id="qp_main215396" style="border-radius:6px;border:1px solid rgb(150,150,150);margin:0px;padding:10px;background:rgb(255,255,255)"><div style="border-radius:6px;font-family:Arial;font-size:12px;font-weight:bold;background-color:rgb(44,44,44);color:rgb(255,255,255);margin-bottom:10px"><div style="padding:10px">What's the next feature for SkipShuffle</div></div><form id="qp_form215396" action="http://www.poll-maker.com/results215396x61c440c5-9" method="post" target="_blank" style="display:inline;margin:0px;padding:0px"><div style="border-radius:6px"><div style="display:block;font-family:Arial;font-size:12px;color:rgb(0,0,0);padding-top:5px;padding-bottom:5px;clear:both;cursor:pointer;cursor:hand"><span onClick="if((!event.target?event.srcElement:event.target).tagName!='INPUT'){var c=this.childNodes[0];c.checked=(c.type=='radio'?true:!c.checked);}" style="display:block;padding-left:30px"><input style="float:left;width:18px;margin-left:-25px;margin-top:-2px;padding:0px;height:18px" name="qp_v215396" type="radio" value="1">Content Browser</span></div><div style="display:block;font-family:Arial;font-size:12px;color:rgb(0,0,0);padding-top:5px;padding-bottom:5px;clear:both;cursor:pointer;cursor:hand"><span onClick="if((!event.target?event.srcElement:event.target).tagName!='INPUT'){var c=this.childNodes[0];c.checked=(c.type=='radio'?true:!c.checked);}" style="display:block;padding-left:30px"><input style="float:left;width:18px;margin-left:-25px;margin-top:-2px;padding:0px;height:18px" name="qp_v215396" type="radio" value="2">Ability to fast forward and rewind</span></div></div><div style="padding-top:5px;margin-right:-5px;clear:both"><a class="qp_btna" href="#"><input name="qp_b215396" style="width:80px;height:30px;margin-right:5px;border-radius:10px;border:1px solid rgb(150,150,150);font-family:Arial;font-size:12px;font-weight:bold;color:rgb(0,0,0);cursor:pointer;cursor:hand;background:rgb(200,200,200)" type="submit" btype="v" value="Vote"></a><a class="qp_btna" href="#"><input name="qp_b215396" style="width:80px;height:30px;margin-right:5px;border-radius:10px;border:1px solid rgb(150,150,150);font-family:Arial;font-size:12px;font-weight:bold;color:rgb(0,0,0);cursor:pointer;cursor:hand;background:rgb(200,200,200)" type="submit" btype="r" value="Results"></a></div><a id="qp_a215396" style="float:right;font-family:Arial;font-size:10px;color:rgb(0,0,0);text-decoration:none;margin-top:-12px;margin-right:-5px" href="http://www.poll-maker.com">Poll Maker</a></form></div><script src="http://scripts.poll-maker.com/3012/scpolls.js" language="javascript"></script>
...
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                                      ...
                                      <input type="hidden" name="encrypted" value="-----BEGIN PKCS7----------END PKCS7-----
                                      ">
